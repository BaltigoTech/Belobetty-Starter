...
const initialFilePathUser = "../../../docs/users/"
...
func TestCreateUserWithOutUserName(t *testing.T) {
	user, err := entity.NewUser("", "gabriel@belobetty.com", "Gabriel Ferrara", nil)
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestCreateUserInvalidUserName(t *testing.T) {
	user, err := entity.NewUser("StringToNameWithMoreThan34Caracteres12345", "gabriel@belobetty.com", "Gabriel Ferrara", nil)
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestCreateUserWithOutOrInvalidEmail(t *testing.T) {
	user, err := entity.NewUser("gabGit", "gabriel@.com", "Gabriel Ferrara", nil)
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestCreateUserWithOutEmail(t *testing.T) {
	user, err := entity.NewUser("gabGit", "", "Gabriel Ferrara", nil)
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestCreateUserWithOutName(t *testing.T) {
	user, err := entity.NewUser("gabGit", "gabriel@belobetty.com", "", nil)
	assert.Nil(t, user)
	assert.NotNil(t, err)
...
func TestCreateUserWithInvalidPermission(t *testing.T) {
	...
	access, err := entity.NewAccessRepository("RepoTest", "Error")
	assert.Nil(t, access)
	assert.NotNil(t, err)
